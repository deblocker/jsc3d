...
t.request=null}},this.onprogress&&(this.onprogress("Loading CTM file ...",0),i.onprogress=function(e){t.onprogress("Loading CTM file ...",e.position/e.totalSize)}),this.request=i,i.send()},JSC3D.OpenCTMLoader.prototype.abort=function(){this.req&&(this.req.abort(),this.req=null)},JSC3D.OpenCTMLoader.prototype.parseCTM=function(e,t){var r=new JSC3D.CTM.File(new JSC3D.CTM.Stream(t)),o=new JSC3D.Mesh,i=e.name||"ctm"
o.indexBuffer=new Int32Array(4*r.body.indices.length/3)
for(var s=0,n=0,a=r.body.indices,d=a.length;d>s;s+=3,n+=4)o.indexBuffer[n]=a[s],o.indexBuffer[n+1]=a[s+1],o.indexBuffer[n+2]=a[s+2],o.indexBuffer[n+3]=-1
if(o.vertexBuffer=r.body.vertices,r.body.uvMaps&&r.body.uvMaps.length>0){var h=this,c=new JSC3D.Texture(r.body.uvMaps[0].name,function(){o.setTexture(this),h.onresource&&h.onresource(this)})
c.createFromUrl(this.urlPath+r.body.uvMaps[0].filename),o.texCoordBuffer=r.body.uvMaps[0].uv
for(var s=1,d=o.texCoordBuffer.length;d>s;s+=2)o.texCoordBuffer[s]=1-o.texCoordBuffer[s]}o.isTrivial()||e.addChild(o)},JSC3D.OpenCTMLoader.prototype.onload=null,JSC3D.OpenCTMLoader.prototype.onerror=null,JSC3D.OpenCTMLoader.prototype.onprogress=null,JSC3D.OpenCTMLoader.prototype.onresource=null,JSC3D.LoaderSelector.registerLoader("ctm",JSC3D.OpenCTMLoader),function(e){var t=t||{}
...
for(this._code=0,this._range=-1;e--;)this._code=this._code<<8|this._stream.readByte()},r.RangeDecoder.prototype.decodeDirectBits=function(e){for(var t=0,r=e,o;r--;)this._range>>>=1,o=this._code-this._range>>>31,this._code-=this._range&o-1,t=t<<1|1-o,0===(4278190080&this._range)&&(this._code=this._code<<8|this._stream.readByte(),this._range<<=8)
return t},r.RangeDecoder.prototype.decodeBit=function(e,t){var r=e[t],o=(this._range>>>11)*r
...
while(256>t)
return 255&t},r.Decoder2.prototype.decodeWithMatchByte=function(e,t){var r=1,o,i
do if(o=t>>7&1,t<<=1,i=e.decodeBit(this._decoders,(1+o<<8)+r),r=r<<1|i,o!==i){for(;256>r;)r=r<<1|e.decodeBit(this._decoders,r)
break}while(256>r)
return 255&r},r.LiteralDecoder=function(){},r.LiteralDecoder.prototype.create=function(e,t){var o
...
this._lenDecoder.init(),this._repLenDecoder.init(),this._posAlignDecoder.init(),this._rangeDecoder.init()},r.Decoder.prototype.decode=function(e,t,o){var i=0,s=0,n=0,a=0,d=0,h=0,c=0,p,l,u,f,_,y
for(this._rangeDecoder.setStream(e),this._outWindow.setStream(t),this.init();0>o||o>h;)if(p=h&this._posStateMask,0===this._rangeDecoder.decodeBit(this._isMatchDecoders,(i<<4)+p))l=this._literalDecoder.getDecoder(h++,c),c=i>=7?l.decodeWithMatchByte(this._rangeDecoder,this._outWindow.getByte(s)):l.decodeNormal(this._rangeDecoder),this._outWindow.putByte(c),i=4>i?0:i-(10>i?3:6)
else{if(1===this._rangeDecoder.decodeBit(this._isRepDecoders,i))u=0,0===this._rangeDecoder.decodeBit(this._isRepG0Decoders,i)?0===this._rangeDecoder.decodeBit(this._isRep0LongDecoders,(i<<4)+p)&&(i=7>i?9:11,u=1):(0===this._rangeDecoder.decodeBit(this._isRepG1Decoders,i)?f=n:(0===this._rangeDecoder.decodeBit(this._isRepG2Decoders,i)?f=a:(f=d,d=a),a=n),n=s,s=f),0===u&&(u=2+this._repLenDecoder.decode(this._rangeDecoder,p),i=7>i?8:11)
else if(d=a,a=n,n=s,u=2+this._lenDecoder.decode(this._rangeDecoder,p),i=7>i?7:10,_=this._posSlotDecoder[5>=u?u-2:3].decode(this._rangeDecoder),_>=4){if(y=(_>>1)-1,s=(2|1&_)<<y,14>_)s+=r.reverseDecode2(this._posDecoders,s-_-1,this._rangeDecoder,y)
else if(s+=this._rangeDecoder.decodeDirectBits(y-4)<<4,s+=this._posAlignDecoder.reverseDecode(this._rangeDecoder),0>s){if(-1===s)break
return!1}}else s=_
if(s>=h||s>=this._dictionarySizeCheck)return!1
this._outWindow.copyBlock(s,u),h+=u,c=this._outWindow.getByte(0)}return this._outWindow.flush(),this._outWindow.releaseStream(),this._rangeDecoder.releaseStream(),!0},r.Decoder.prototype.setDecoderProperties=function(e){var t,r,o,i,s
